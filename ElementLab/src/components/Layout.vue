<template>
  <el-container>
    <el-header>Hello Element</el-header>
    <el-container>
      <el-aside>
        ...
        >
          <el-submenu index="Basic">
            ...
            <el-menu-item-group>
              <el-menu-item index="Basic-TabLab" :route="{name: 'TabLab'}">TabLab</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="Form">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="Form-DatePickerLab" :route="{name: 'DatePickerLab'}">DatePickerLab</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
...
export default {
  ...
  methods: {
    ...
    selectedHandler(index, indexPath) {
